...
public class PasswordComplyUsingHooksTest {
	...
	private static void prepareLoadTestData() {
		try {
			// Do not forget to change the location of file HELP NEED TO UNDERSTAND!!!
			myFileReader = new File(
					"C:\\Users\\kelly\\Documents\\workspace-spring-tool-suite-4-4.20.0.RELEASE\\glabjunit\\PasswordFile.txt");
